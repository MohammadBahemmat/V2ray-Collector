...
<head>
    ...
    <style>
        ...
        /* حاشیه‌ی رنگین‌کمانی چرخان با pseudo-element */
        ...
        /* استایل خط افقی داخل بخش‌ها */
        hr {
            border: none;
            height: 2px;
            background: linear-gradient(90deg, #6c63ff, #ff6584, #ffcc00);
            border-radius: 2px;
            margin: 20px 0;
        }

        /* استایل‌های موجود شما می‌توانند باقی بمانند */
        .ltr-block {
            direction: ltr;
            background-color: #0d1117;
            padding: 12px;
...
<div class="container">
    ...
    <!-- پیام بالای صفحه بدون کادر متحرک -->
